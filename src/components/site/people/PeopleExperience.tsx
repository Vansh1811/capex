...
/**
 * PeopleExperience: the scene-tone chrome for the People page — the same
 * architecture as the homepage and About (the STUDIO ecosystem's shared
 * chassis): HomeNav, scene data-tone marks driving the nav's color in
 * place, and the approved Studio + Search overlays reused unchanged.
 * The page arrives from STUDIO → PEOPLE and keeps that grammar intact.
 */
...
/**
 * PLATE VOCABULARY — the reference-imagery caption every photographic frame
 * on this page carries. The page never presents reference frames as Capex
 * people or Capex work.
 */
