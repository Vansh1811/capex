...
/**
 * CredentialsExperience: the shared Studio chassis for PROOF OF PRACTICE —
 * the same architecture as the homepage, About, Sectors, People and Contact
 * (HomeNav, scene data-tone marks driving the nav's colour in place, and
 * the approved Studio + Search overlays reused unchanged). The page arrives
 * from STUDIO → CREDENTIALS and keeps that grammar intact; it then diverges
 * as the evidentiary movement of the ecosystem — the register, the record
 * and the verification desk.
 */
export function CredentialsExperience({
  brandWordmark,
  corpus,
  children,
}: {
